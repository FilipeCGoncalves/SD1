...
public class TTTClient {
	...
	public void playGame() {
		...
		do {
			player = ++player % 2;
			do {
				// getDefaultInstance() is for avoiding creating empty request messages *!*
				currentBoard = s.currentBoard(TttContract.currentBoardRequest.getDefaultInstance()).getBoard();
			...
			winner = s.checkWinner(TttContract.winnerRequest.getDefaultInstance()).getWinner();
